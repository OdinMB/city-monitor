...
import { usePharmacies } from './usePharmacies.js';

const mockData = [
  { name: 'Apotheke am Bahnhof', address: 'Friedrichstr. 1', lat: 52.52, lon: 13.39, phone: '+49301234567', distance: 500 },
];
...
describe('usePharmacies', () => {
  ...
  it('fetches data for a city', async () => {
    ...
    const { result } = renderHook(() => usePharmacies('berlin'), {
