...
const mockData = [
  { id: '1', title: 'Concert', venue: 'Arena', date: '2026-03-05', category: 'music', url: 'https://example.com', free: false, source: 'ticketmaster' },
];
...
describe('useEvents', () => {
  ...
  it('fetches data for a city', async () => {
    ...
    const { result } = renderHook(() => useEvents('berlin'), {
