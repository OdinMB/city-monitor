...
import { useLaborMarket } from './useLaborMarket.js';

const mockData = {
  month: '2026-02',
  unemployment: { total: 195000, rate: 9.8, yoy: -0.3 },
  sgbII: { total: 145000, rate: 7.3 },
};
...
describe('useLaborMarket', () => {
  ...
  it('fetches data for a city', async () => {
    ...
    const { result } = renderHook(() => useLaborMarket('berlin'), {
